...
//     // Load the main SCSS from your theme or Boost
//     $main = theme_prakrity_get_main_scss_content($theme);

//     // Load the post.scss file
//     $post = file_get_contents($CFG->dirroot . '/theme/prakrity/scss/post.scss');
